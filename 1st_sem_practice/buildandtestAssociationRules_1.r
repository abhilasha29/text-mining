...
#build rules
trainegs = read.transactions(file="L:\\Barry\\webanalytics\\demodata&code\\simplebasket.csv",rm.duplicates=TRUE, format="single", sep=",", cols=c("basketID","item"));
...
#read the test data
testegs = read.csv(file="L:\\Barry\\webanalytics\\demodata&code\\simplebasket-test.csv");
